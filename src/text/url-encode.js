...
export const template = `
  <div class="tool-container space-y-4">
    ...
    <div class="flex gap-3 justify-center flex-wrap">
      <button id="encodeBtn" class="px-6 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors text-sm font-medium">Encode</button>
      <button id="decodeBtn" class="px-6 py-2 bg-slate-600 dark:bg-slate-500 text-white rounded-md hover:bg-slate-700 dark:hover:bg-slate-600 transition-colors text-sm font-medium">Decode</button>
