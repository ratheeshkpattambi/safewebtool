    ...
    <div class="tool-container">
      ...
      <div class="my-4 flex flex-col gap-4">
        ...
        <div class="flex gap-4">
          <button id="processBtn" class="flex-1 py-3 px-6 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed">Trim Video</button>
        </div>
      </div>
