    ...
    <div class="tool-container">
      ...
      <div class="my-4 grid gap-4 md:grid-cols-2">
        <div class="flex flex-col gap-2">
          ...
          <input type="number" id="width" placeholder="Width" value="320" class="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-base bg-white dark:bg-gray-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors">
        </div>
        <div class="flex flex-col gap-2">
          <label for="height" class="font-medium text-slate-700 dark:text-slate-300">Height:</label>
          <input type="number" id="height" placeholder="Height" value="240" class="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-base bg-white dark:bg-gray-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors">
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="flex items-center">
            <input type="number" id="fps" min="1" max="30" value="10" class="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-base w-24 bg-white dark:bg-gray-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors">
        ...
        <div class="flex flex-col gap-2 md:col-span-2">
          ...
          <select id="quality" class="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-base bg-white dark:bg-gray-800 text-slate-900 dark:text-slate-100 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors">
        ...
        <div class="flex flex-col gap-2 md:col-span-2">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="flex flex-col gap-1">
              ...
              <input type="text" id="startTime" placeholder="0:00" value="0:00" class="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-base bg-white dark:bg-gray-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors">
            </div>
            <div class="flex flex-col gap-1">
              <label for="duration" class="text-sm text-slate-600 dark:text-slate-400">Duration:</label>
              <input type="text" id="duration" placeholder="5.0" value="5.0" class="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-base bg-white dark:bg-gray-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors">
              <span class="text-xs text-slate-500 dark:text-slate-400">seconds</span>
            </div>
          </div>
        </div>
        <button id="processBtn" class="w-full py-3 px-6 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed md:col-span-2">Convert to GIF</button>
      </div>
